...
const product1 = new Product2("Ноутбук", electronics);
const product2 = new Product2("Навушники", electronics);
const product3 = new Product2("Воно", books);
const product4 = new Product2("Смартфон", Group.create("Електроніка")); // тут створюється нова група або використовується вже створена
...
const list1 = [product1, product2, product3, product4].filter(
(product) => product.group === Group.create("Електроніка")
);

console.log(list1); // виводиться список продуктів, що належать до групи "Електроніка"